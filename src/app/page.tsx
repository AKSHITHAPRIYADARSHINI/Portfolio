          ...
          <BlurFade delay={BLUR_FADE_DELAY * 13}>
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  Currently a member of professional organizations, active communities and participate in {" "}
                  {DATA.hackathons.length}+ events, 
                  I enjoy networking and expanding my professional growth.
                  I participate in hackathons to collaborate with passionate individuals worldwide, 
                  learn new skills, and drive innovative solutions.
                </p>
              </div>
            </div>
          </BlurFade>
